 ...
 * Gestiona el acceso a las líneas de servicio o ítems facturables asociados a las citas.
...
public interface TratamientoRepository extends JpaRepository<Tratamiento, Long> {
     ...
     * Útil para auditar qué tipos de servicios se están realizando (ej: buscar todas las "Vacunas").
     ...
     * Es la consulta principal para construir la "factura" o detalle de la visita médica.
     *
