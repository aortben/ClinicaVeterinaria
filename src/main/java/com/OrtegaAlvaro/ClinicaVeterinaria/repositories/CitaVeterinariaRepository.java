...
public interface CitaVeterinariaRepository extends JpaRepository<CitaVeterinaria, Long> {
     ...
     * Los resultados se ordenan cronológicamente de más reciente a más antiguo (DESC),
     ...
     * Utilizado para alimentar el widget de "Actividad Reciente" en el Dashboard principal.
     *
